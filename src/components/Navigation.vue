<template>
  ...
  >
    ...
    <v-card-subtitle>
      <h2><div @click="scrollToContent('home')">Home</div></h2>
    </v-card-subtitle>
    <v-divider width="60"></v-divider>
    <v-card-subtitle>
      <!-- { path: '/Pulse/Definition',id:'Alignment'}" -->
      <h2>
        <div @click="scrollToContent('ecommerce')">E-Commerce</div>
      </h2>
    </v-card-subtitle>
    ...
    <CardNav :dialog="clickCart"></CardNav>
  </v-navigation-drawer>
</template>
